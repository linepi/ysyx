...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 01110 11", srlw   ,  R, R(rd) = (sword_t)(int32_t)((uint32_t)src1 >> (uint32_t)src2));
  INSTPAT("0100000 ????? ????? 101 ????? 01110 11", sraw   ,  R, R(rd) = (sword_t)((int32_t)src2 >> (uint32_t)src2));
