...
void test_expr() {
  FILE *fp =
      fopen("/home/w/dev/ysyx-workbench/nemu/tools/gen-expr/build/test0", "r");

  ((void)sizeof((fp != ((void *)0)) ? 1 : 0), __extension__({
     if (fp != ((void *)0))
       ;
     else
       __assert_fail("fp != NULL", "tests/test_expr.c", 8,
