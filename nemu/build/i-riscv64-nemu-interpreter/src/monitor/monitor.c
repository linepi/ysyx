...
static void welcome() {
  do {
    printf(
        ...
        "Trace: %s"
        "\n",
        "src/monitor/monitor.c", 28, __func__,
        "\33[1;32m"
        "ON"
        "\33[0m");
    do {
  ...
  do {
    printf(
        ...
        "Build time: %s, %s"
        "\n",
        "src/monitor/monitor.c", 32, __func__, "19:23:24", "Apr 17 2023");
    do {
      extern FILE *log_fp;
      extern _Bool log_enable();
      if (log_enable()) {
        fprintf(log_fp,
                ...
                "Build time: %s, %s"
                "\n",
                "src/monitor/monitor.c", 32, __func__, "19:23:24",
                "Apr 17 2023");
        fflush(log_fp);
      }
    } while (0);
...
static char *diff_so_file = ((void *)0);
static char *img_file = ((void *)0);
...
static long load_img() {
  ...
  do {
    if (!(fp)) {
      ...
      assert_fail_msg();
      ((void)sizeof((fp) ? 1 : 0), __extension__({
         if (fp)
           ;
         else
           __assert_fail("fp", "src/monitor/monitor.c", 54,
  ...
  ((void)sizeof((ret == 1) ? 1 : 0), __extension__({
     if (ret == 1)
       ;
     else
       __assert_fail("ret == 1", "src/monitor/monitor.c", 63,
                     __extension__ __PRETTY_FUNCTION__);
   }));
...
static int parse_args(int argc, char *argv[]) {
  const struct option table[] = {
      {"batch", 0, ((void *)0), 'b'}, {"log", 1, ((void *)0), 'l'},
      {"diff", 1, ((void *)0), 'd'},  {"port", 1, ((void *)0), 'p'},
      {"help", 0, ((void *)0), 'h'},  {0, 0, ((void *)0), 0},
  };
  int o;
