          ...
          ((void)sizeof((c == '0' || c == '1' || c == '?') ? 1 : 0),
           __extension__({
             if (c == '0' || c == '1' || c == '?')
               ...
               __assert_fail(
                   "c == '0' || c == '1' || c == '?'",
                   "/home/w/dev/ysyx-workbench/nemu/include/cpu/decode.h", 53,
    ...
    if (!(0)) {
      ...
      ((void)sizeof((0) ? 1 : 0), __extension__({
         if (0)
           ...
           __assert_fail("0",
                         "/home/w/dev/ysyx-workbench/nemu/include/cpu/decode.h",
           ...
           __extension__({
             if ((c >= '0' && c <= '9') || (c >= 'a' && c <= 'f') || c == '?')
               ...
               __assert_fail(
                   "(c >= '0' && c <= '9') || (c >= 'a' && c <= 'f') || c == "
                   "'?'",
                   "/home/w/dev/ysyx-workbench/nemu/include/cpu/decode.h", 79,
                   __extension__ __PRETTY_FUNCTION__);
           }));
        }
      } while (0);
  ...
  for (WP *i = get_wp_head(); i; i = i->next) {
    ...
    if (!success) {
      printf(
          ...
          "\33[0m"
          "Invalid expression\n",
          "src/cpu/cpu-exec.c", 48, __func__);
      continue;
    }
    if (val != i->val) {
      printf(
...
static void statistic() {
  ...
  do {
    printf(
        ...
        " us"
        "\n",
        "src/cpu/cpu-exec.c", 109, __func__, g_timer);
    do {
      extern FILE *log_fp;
      extern _Bool log_enable();
      if (log_enable()) {
  ...
  do {
    printf(
        ...
        "u"
        "\n",
        "src/cpu/cpu-exec.c", 110, __func__, g_nr_guest_inst);
    do {
      extern FILE *log_fp;
      extern _Bool log_enable();
      if (log_enable()) {
  ...
  if (g_timer > 0) do {
      printf(
          ...
          " inst/s"
          "\n",
          "src/cpu/cpu-exec.c", 111, __func__,
    ...
    do {
      printf(
          ...
          "simulation frequency"
          "\n",
          "src/cpu/cpu-exec.c", 112, __func__);
      do {
        extern FILE *log_fp;
        extern _Bool log_enable();
        if (log_enable()) {
    ...
    case NEMU_ABORT:
      do {
        printf(
            ...
            "x"
            "\n",
            "src/cpu/cpu-exec.c", 141, __func__,
