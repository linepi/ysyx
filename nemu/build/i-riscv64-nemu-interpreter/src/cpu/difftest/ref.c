...
void difftest_memcpy(paddr_t addr, void *buf, size_t n, _Bool direction) {
  ((void)sizeof((0) ? 1 : 0), __extension__({
     if (0)
       ...
       __assert_fail("0", "src/cpu/difftest/ref.c", 22,
...
void difftest_regcpy(void *dut, _Bool direction) {
  ((void)sizeof((0) ? 1 : 0), __extension__({
     if (0)
       ...
       __assert_fail("0", "src/cpu/difftest/ref.c", 26,
                     __extension__ __PRETTY_FUNCTION__);
   }));
}
...
void difftest_exec(uint64_t n) {
  ((void)sizeof((0) ? 1 : 0), __extension__({
     if (0)
       ...
       __assert_fail("0", "src/cpu/difftest/ref.c", 30,
                     __extension__ __PRETTY_FUNCTION__);
   }));
}
...
void difftest_raise_intr(word_t NO) {
  ((void)sizeof((0) ? 1 : 0), __extension__({
     if (0)
       ...
       __assert_fail("0", "src/cpu/difftest/ref.c", 34,
                     __extension__ __PRETTY_FUNCTION__);
   }));
}
