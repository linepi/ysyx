...
VL_ATTR_COLD void Vnb___024root___eval_initial__TOP(Vnb___024root* vlSelf) {
    ...
    vlSelf->nb__DOT__cnt = 0U;
    vlSelf->seg4 = (0x80U | (IData)(vlSelf->seg4));
    vlSelf->seg5 = (0x80U | (IData)(vlSelf->seg5));
    vlSelf->seg6 = (0x80U | (IData)(vlSelf->seg6));
    vlSelf->seg7 = (0x80U | (IData)(vlSelf->seg7));
...
extern const VlUnpacked<CData/*6:0*/, 16> Vnb__ConstPool__TABLE_hb2a417e2_0;
...
VL_ATTR_COLD void Vnb___024root___stl_sequent__TOP__0(Vnb___024root* vlSelf) {
    ...
    CData/*6:0*/ nb__DOT____Vcellout__encode_seg_ins2____pinNumber3;
    nb__DOT____Vcellout__encode_seg_ins2____pinNumber3 = 0;
    CData/*6:0*/ nb__DOT____Vcellout__encode_seg_ins3____pinNumber3;
    nb__DOT____Vcellout__encode_seg_ins3____pinNumber3 = 0;
    CData/*6:0*/ nb__DOT____Vcellout__encode_seg_ins4____pinNumber3;
    nb__DOT____Vcellout__encode_seg_ins4____pinNumber3 = 0;
    CData/*6:0*/ nb__DOT____Vcellout__encode_seg_ins5____pinNumber3;
    nb__DOT____Vcellout__encode_seg_ins5____pinNumber3 = 0;
    CData/*6:0*/ nb__DOT____Vcellout__encode_seg_ins6____pinNumber3;
    nb__DOT____Vcellout__encode_seg_ins6____pinNumber3 = 0;
    CData/*6:0*/ nb__DOT____Vcellout__encode_seg_ins7____pinNumber3;
    nb__DOT____Vcellout__encode_seg_ins7____pinNumber3 = 0;
    ...
    __Vtableidx9 = 0;
    // Body
    __Vtableidx6 = (0xfU & (IData)(vlSelf->nb__DOT__cnt));
    nb__DOT____Vcellout__encode_seg_ins4____pinNumber3 
        = Vnb__ConstPool__TABLE_hb2a417e2_0[__Vtableidx6];
    __Vtableidx7 = (0xfU & ((IData)(vlSelf->nb__DOT__cnt) 
                            >> 4U));
    nb__DOT____Vcellout__encode_seg_ins5____pinNumber3 
        = Vnb__ConstPool__TABLE_hb2a417e2_0[__Vtableidx7];
    __Vtableidx8 = (0xfU & ((IData)(vlSelf->nb__DOT__cnt) 
                            >> 8U));
    nb__DOT____Vcellout__encode_seg_ins6____pinNumber3 
        = Vnb__ConstPool__TABLE_hb2a417e2_0[__Vtableidx8];
    __Vtableidx9 = (0xfU & ((IData)(vlSelf->nb__DOT__cnt) 
                            >> 0xcU));
    nb__DOT____Vcellout__encode_seg_ins7____pinNumber3 
        = Vnb__ConstPool__TABLE_hb2a417e2_0[__Vtableidx9];
    ...
    __Vtableidx3 = ((0x1eU & ((IData)(vlSelf->nb__DOT__code) 
                              >> 3U)) | (IData)(vlSelf->nb__DOT__enable));
    nb__DOT____Vcellout__encode_seg_ins1____pinNumber3 
        = Vnb__ConstPool__TABLE_h47d0bdac_0[__Vtableidx3];
    __Vtableidx1 = vlSelf->nb__DOT__code;
    nb__DOT__ascii = Vnb__ConstPool__TABLE_h97957127_0
        [__Vtableidx1];
    vlSelf->seg4 = ((0x80U & (IData)(vlSelf->seg4)) 
                    | (IData)(nb__DOT____Vcellout__encode_seg_ins4____pinNumber3));
    vlSelf->seg5 = ((0x80U & (IData)(vlSelf->seg5)) 
                    | (IData)(nb__DOT____Vcellout__encode_seg_ins5____pinNumber3));
    vlSelf->seg6 = ((0x80U & (IData)(vlSelf->seg6)) 
                    | (IData)(nb__DOT____Vcellout__encode_seg_ins6____pinNumber3));
    vlSelf->seg7 = ((0x80U & (IData)(vlSelf->seg7)) 
                    | (IData)(nb__DOT____Vcellout__encode_seg_ins7____pinNumber3));
    vlSelf->seg0 = ((0x80U & (IData)(vlSelf->seg0)) 
                    | (IData)(nb__DOT____Vcellout__encode_seg_ins0____pinNumber3));
    vlSelf->seg1 = ((0x80U & (IData)(vlSelf->seg1)) 
                    | (IData)(nb__DOT____Vcellout__encode_seg_ins1____pinNumber3));
    __Vtableidx4 = ((0x1eU & ((IData)(nb__DOT__ascii) 
                              << 1U)) | (IData)(vlSelf->nb__DOT__enable));
    nb__DOT____Vcellout__encode_seg_ins2____pinNumber3 
        = Vnb__ConstPool__TABLE_h47d0bdac_0[__Vtableidx4];
    __Vtableidx5 = ((0x1eU & ((IData)(nb__DOT__ascii) 
                              >> 3U)) | (IData)(vlSelf->nb__DOT__enable));
    nb__DOT____Vcellout__encode_seg_ins3____pinNumber3 
        = Vnb__ConstPool__TABLE_h47d0bdac_0[__Vtableidx5];
    vlSelf->seg2 = ((0x80U & (IData)(vlSelf->seg2)) 
                    | (IData)(nb__DOT____Vcellout__encode_seg_ins2____pinNumber3));
    vlSelf->seg3 = ((0x80U & (IData)(vlSelf->seg3)) 
                    | (IData)(nb__DOT____Vcellout__encode_seg_ins3____pinNumber3));
}
...
VL_ATTR_COLD void Vnb___024root___ctor_var_reset(Vnb___024root* vlSelf) {
    ...
    vlSelf->nb__DOT__cnt = VL_RAND_RESET_I(16);
    vlSelf->nb__DOT__enable = VL_RAND_RESET_I(1);
    vlSelf->nb__DOT__keyboard_ins__DOT__loose = VL_RAND_RESET_I(1);
