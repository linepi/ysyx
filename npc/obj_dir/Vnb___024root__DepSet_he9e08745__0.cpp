...
VL_INLINE_OPT void Vnb___024root___nba_sequent__TOP__0(Vnb___024root* vlSelf) {
    ...
    __Vtableidx1 = (0xfU & (IData)(vlSelf->nb__DOT__code));
    vlSelf->seg0 = Vnb__ConstPool__TABLE_hb2a417e2_0
        [__Vtableidx1];
    __Vtableidx2 = (0xfU & ((IData)(vlSelf->nb__DOT__code) 
                            >> 4U));
    vlSelf->seg1 = Vnb__ConstPool__TABLE_hb2a417e2_0
        [__Vtableidx2];
}
