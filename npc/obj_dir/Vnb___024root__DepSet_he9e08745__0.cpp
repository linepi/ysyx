...
VL_INLINE_OPT void Vnb___024root___nba_sequent__TOP__0(Vnb___024root* vlSelf) {
    ...
    CData/*0:0*/ __Vdly__nb__DOT__keyboard_ins__DOT__loose;
    __Vdly__nb__DOT__keyboard_ins__DOT__loose = 0;
    // Body
    __Vdly__nb__DOT__keyboard_ins__DOT__ps2_clk_sync 
        = vlSelf->nb__DOT__keyboard_ins__DOT__ps2_clk_sync;
    __Vdly__nb__DOT__keyboard_ins__DOT__loose = vlSelf->nb__DOT__keyboard_ins__DOT__loose;
    ...
    } else if ((IData)((4U == (6U & (IData)(vlSelf->nb__DOT__keyboard_ins__DOT__ps2_clk_sync))))) {
        if ((0xaU == (IData)(vlSelf->nb__DOT__keyboard_ins__DOT__count))) {
            if (VL_UNLIKELY((((~ (IData)(vlSelf->nb__DOT__keyboard_ins__DOT__buffer)) 
                ...
                VL_WRITEF("receive %x\n",8,(0xffU & 
                                            ((IData)(vlSelf->nb__DOT__keyboard_ins__DOT__buffer) 
                                             >> 1U)));
                vlSelf->nb__DOT__code = (0xffU & ((IData)(vlSelf->nb__DOT__keyboard_ins__DOT__buffer) 
                                                  >> 1U));
                if ((0xf0U == (0x1ffU & (IData)(vlSelf->nb__DOT__keyboard_ins__DOT__buffer)))) {
                    __Vdly__nb__DOT__keyboard_ins__DOT__loose = 1U;
                    vlSelf->nb__DOT__enable = 0U;
                } else {
                    if ((1U & (~ (IData)(vlSelf->nb__DOT__keyboard_ins__DOT__loose)))) {
                        vlSelf->nb__DOT__enable = 1U;
                    }
                    __Vdly__nb__DOT__keyboard_ins__DOT__loose = 0U;
                }
            }
            __Vdly__nb__DOT__keyboard_ins__DOT__count = 0U;
        } else {
    ...
    vlSelf->nb__DOT__keyboard_ins__DOT__ps2_clk_sync 
        = __Vdly__nb__DOT__keyboard_ins__DOT__ps2_clk_sync;
    vlSelf->nb__DOT__keyboard_ins__DOT__loose = __Vdly__nb__DOT__keyboard_ins__DOT__loose;
