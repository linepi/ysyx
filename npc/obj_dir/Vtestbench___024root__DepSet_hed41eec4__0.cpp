...
VL_INLINE_OPT void Vtestbench___024root___nba_sequent__TOP__0(Vtestbench___024root* vlSelf) {
    ...
    // Init
    IData/*31:0*/ __Vdly__testbench__DOT__count_clk;
    __Vdly__testbench__DOT__count_clk = 0;
    // Body
    __Vdly__testbench__DOT__count_clk = vlSelf->testbench__DOT__count_clk;
    if (VL_UNLIKELY((0x3d08fU == vlSelf->testbench__DOT__count_clk))) {
        VL_WRITEF("%1#%1#%1#\n",1,vlSelf->testbench__DOT__Q2,
                  1,(IData)(vlSelf->testbench__DOT__Q1),
                  1,vlSelf->testbench__DOT__Q0);
        __Vdly__testbench__DOT__count_clk = 0U;
    } else {
        __Vdly__testbench__DOT__count_clk = ((IData)(1U) 
                                             + vlSelf->testbench__DOT__count_clk);
    }
    vlSelf->testbench__DOT__count_clk = __Vdly__testbench__DOT__count_clk;
    vlSelf->testbench__DOT__Q0 = vlSelf->testbench__DOT__counter_ins__DOT__w1;
    vlSelf->testbench__DOT__counter_ins__DOT__w1 = 
        (1U & (~ (IData)(vlSelf->testbench__DOT__counter_ins__DOT__w1)));
}
...
VL_INLINE_OPT void Vtestbench___024root___nba_sequent__TOP__1(Vtestbench___024root* vlSelf) {
    ...
    // Body
    vlSelf->testbench__DOT__Q1 = vlSelf->testbench__DOT__counter_ins__DOT__w2;
    vlSelf->testbench__DOT__counter_ins__DOT__w2 = 
        (1U & (~ (IData)(vlSelf->testbench__DOT__counter_ins__DOT__w2)));
}
...
VL_INLINE_OPT void Vtestbench___024root___nba_sequent__TOP__2(Vtestbench___024root* vlSelf) {
    ...
    // Body
    vlSelf->testbench__DOT__Q2 = vlSelf->testbench__DOT__counter_ins__DOT__w3;
    vlSelf->testbench__DOT__counter_ins__DOT__w3 = 
        (1U & (~ (IData)(vlSelf->testbench__DOT__counter_ins__DOT__w3)));
}
