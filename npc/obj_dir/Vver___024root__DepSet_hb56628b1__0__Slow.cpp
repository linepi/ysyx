...
VL_ATTR_COLD void Vver___024root___eval_triggers__stl(Vver___024root* vlSelf);
#ifdef VL_DEBUG
VL_ATTR_COLD void Vver___024root___dump_triggers__stl(Vver___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD void Vver___024root___eval_stl(Vver___024root* vlSelf);
...
VL_ATTR_COLD void Vver___024root___eval_settle(Vver___024root* vlSelf) {
    ...
    while (__VstlContinue) {
        __VstlContinue = 0U;
        Vver___024root___eval_triggers__stl(vlSelf);
        if (vlSelf->__VstlTriggered.any()) {
            __VstlContinue = 1U;
            if (VL_UNLIKELY((0x64U < vlSelf->__VstlIterCount))) {
#ifdef VL_DEBUG
                Vver___024root___dump_triggers__stl(vlSelf);
#endif
                VL_FATAL_MT("/home/w/dev/ysyx-workbench/npc/vsrc/ver/ver.v", 1, "", "Settle region did not converge.");
            }
            vlSelf->__VstlIterCount = ((IData)(1U) 
                                       + vlSelf->__VstlIterCount);
            Vver___024root___eval_stl(vlSelf);
        }
    }
}
...
VL_ATTR_COLD void Vver___024root___dump_triggers__stl(Vver___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vver__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vver___024root___dump_triggers__stl\n"); );
    // Body
...
void Vver___024root___ico_sequent__TOP__0(Vver___024root* vlSelf);

VL_ATTR_COLD void Vver___024root___eval_stl(Vver___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vver__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vver___024root___eval_stl\n"); );
    // Body
    if (vlSelf->__VstlTriggered.at(0U)) {
...
VL_ATTR_COLD void Vver___024root___dump_triggers__ico(Vver___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vver__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vver___024root___dump_triggers__ico\n"); );
    // Body
